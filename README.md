...
| Week 8 | Lecture - Basic Sorting  <br> Lab - Basic sorting algorithms  | [Lecture Slides](/lecture/lecture11.pdf)<br>[Lecture Slides](/lecture/lecture12.pdf)<br>[Lab]()|
| Week 9 | Lecture - Multidimensional Arrays <br> Lecture - Pointers <br> Lab - Programming Exercises (pointers) <br> Reading - Savitch, Chapter 9 <br> |[Lecture Slides](/lecture/lecture13.pdf)<br>[Lecture Slides](/lecture/lecture14.pdf)<br>[Lab](/labs/lab-06) | 
| Week 10 | Assignment - Assignment 3 <br> Lecture - Recursion and Examples <br> Lecture - Recursion (cont.) and Examples  <br> Lab - Programming Exercises (tracing recursion, drawing recursion trees)  | [Lecture Slides](/lecture/lecture15.pdf)<br>[Lecture Slides](/lecture/lecture16.pdf)<br>[Lab](/labs/lab-07) | 
